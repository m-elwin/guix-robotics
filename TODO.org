* Create a custom
keyword argument to the build phase that sets the original directory
- This might require wrapping/overriding cmake-build.
  Or more simply, can add a custom phase in the lwoer function (then it's not accessible to modify-phases however)
* List
